...
%%
%%
%% This version of `tikzposterColorpalettes.tex' has been modified by Edoardo Baldi to fit the posters' style
...
%%% COSMO color palette
\definecolorpalette{COSMO}{%
    %\definecolor{colorOne}{RGB}{239,51,64} % EPFL red
    \definecolor{colorOne}{HTML}{ED1C23} % EPFL red (correct one)
    \definecolor{colorTwo}{HTML}{A2C4D9} % blue
    \definecolor{colorThree}{HTML}{E89261} % orange
}
