...
%%
%%
%% This version of `tikzposterBlockstyles.tex' has been modified by Edoardo Baldi to fit the posters' style
...
%%
 ...
 \defineblockstyle{Default}{
    ...
    bodyverticalshift=0pt, roundedcorners=20, linewidth=0.4cm,
    ...
    \begin{scope}[line width=\blocklinewidth, rounded corners=\blockroundedcorners]
        \ifBlockHasTitle %
           ...
           \filldraw[fill=blockbodybgcolor, draw=blocktitlebgcolor] (blockbody.south west) rectangle (blockbody.north east);
        \else
           \filldraw[fill=blockbodybgcolor, draw=framecolor] (blockbody.south west) rectangle (blockbody.north east);
        \fi
    \end{scope}
}
...
%%% COSMO block styles
%% Style 1: based on Default blockstyle
\defineblockstyle{COSMOblock1}{%
    titlewidthscale=1, bodywidthscale=1, titleleft,
    titleoffsetx=0pt, titleoffsety=0pt, bodyoffsetx=0pt, bodyoffsety=0pt,
    bodyverticalshift=0pt, roundedcorners=10, linewidth=0.2cm,
    titleinnersep=1cm, bodyinnersep=1cm
}{%
    \begin{scope}[line width=\blocklinewidth, rounded corners=\blockroundedcorners]
        \ifBlockHasTitle %
            \filldraw[fill=blocktitlebgcolor, draw=blocktitlebgcolor, rounded corners=\blockroundedcorners] (blockbody.south west) rectangle (blocktitle.north east);
            \filldraw[fill=blockbodybgcolor, draw=blocktitlebgcolor] (blockbody.south west) rectangle (blockbody.north east);
        \else
            \filldraw[fill=blockbodybgcolor, draw=framecolor] (blockbody.south west) rectangle (blockbody.north east);
        \fi
...
%% Style 2: based on Slide style
\defineblockstyle{COSMOblock2}{%
    titlewidthscale=1, bodywidthscale=1, titleleft,
    titleoffsetx=0pt, titleoffsety=0pt, bodyoffsetx=0pt, bodyoffsety=0pt,
    bodyverticalshift=0pt, roundedcorners=0, linewidth=0.1cm, titleinnersep=1cm,
    bodyinnersep=1cm
}{%
    \ifBlockHasTitle%
        \shadedraw[draw=none, left color=blocktitlebgcolor, right color=blockbodybgcolor]
           (blocktitle.south west) rectangle (blocktitle.north east);
    \fi%
    \draw[draw=framecolor, fill=blockbodybgcolor, line width=\blocklinewidth] %
        (blockbody.north west) [rounded corners=10] -- (blockbody.south west) --
        (blockbody.south east) [rounded corners=0]-- (blockbody.north east) -- cycle;
}
