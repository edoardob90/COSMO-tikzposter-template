...
%%
%%
%% This version of `tikzposterColorstyles.tex' has been modified by Edoardo Baldi to fit the posters' style
...
%%% COSMO custom colorstyle
\definecolorstyle{Switzerland}{%
   % Default colors: COSMO palette
    \definecolor{colorOne}{RGB}{239,51,64} % red
    \definecolor{colorTwo}{RGB}{255,255,255} % white
    \definecolor{colorThree}{HTML}{E89261} % TEMPORARY orange
}{%
    % Background colors
    \colorlet{backgroundcolor}{white}
