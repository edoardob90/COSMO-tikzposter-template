...
%%
%%
%% This version of `tikzposterTitlestyles.tex' has been modified by Edoardo Baldi to fit the posters' style
...
%%% COSMO title styles
%% COSMO1: with rectangular frame
\definetitlestyle{COSMOtitle1}{
    width=0.9\textwidth, roundedcorners=20, linewidth=0.4cm, innersep=1cm,
    titletotopverticalspace=15mm, titletoblockverticalspace=20mm,
    titlegraphictotitledistance=1cm, titletextscale=1
}{
    \begin{scope}[line width=\titlelinewidth, rounded corners=\titleroundedcorners]
        \draw[color=framecolor, fill=titlebgcolor]%
        (\titleposleft,\titleposbottom) rectangle (\titleposright,\titlepostop);
...
%% COSMO2: DEFAULT, without rectangular frame
\definetitlestyle{COSMOtitle2}{
    width=0.9\textwidth, roundedcorners=20, linewidth=0.4cm, innersep=1cm,
    titletotopverticalspace=15mm, titletoblockverticalspace=20mm,
    titlegraphictotitledistance=1cm, titletextscale=1
}{}
