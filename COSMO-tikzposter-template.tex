...
%% at the Laboratory of COmputational Science and MOdelling (COSMO)
%%
%% Copyright (C) 2015
%%
%%
...
\documentclass[25pt, a0paper, portrait, margin=0mm, innermargin=15mm,
 ...
 \MyTitle{COSMO TiKz Poster Template}
 \MyAuthor{Tyler Durden}
 \institute{Laboratory of Computational Science and Modelling, IMX \\ 
    \'{E}cole Polytechnique F\'{e}d\'{e}rale de Lausanne \\
    Lausanne, Switzerland}
 \titlegraphic{\includegraphics[width=0.3\textwidth]{Pictures/cosmo_logo}}
